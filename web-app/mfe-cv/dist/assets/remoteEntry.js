const currentImports = {};
      ...
      let moduleMap = {
"./CVApp":()=>{
      dynamicLoadingCss(["style-6IQyD6-j.css"], false, './CVApp');
      return __federation_import('./__federation_expose_CVApp-BNsNlq1Y.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__mfe_cv__' + exposeItemName;
