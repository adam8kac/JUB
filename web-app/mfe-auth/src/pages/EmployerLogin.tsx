...
export default function EmployerLogin() {
  ...
  async function handleSubmit(e: FormEvent) {
    e.preventDefault()
    setError('')
    if (!email || !password) { setError('Prosimo izpolnite vsa polja.'); return }
    setLoading(true)
    try {
    ...
    <div className="min-h-[calc(100vh-64px)] bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Prijava za delodajalce</h1>
          <p className="text-gray-500 mt-1">Upravljajte vaše razpise</p>
        </div>
