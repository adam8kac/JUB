const currentImports = {};
      ...
      let moduleMap = {
"./AuthApp":()=>{
      dynamicLoadingCss(["style-DnUml6hs.css"], false, './AuthApp');
      return __federation_import('./__federation_expose_AuthApp-DjITtuIo.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
        ...
        cssFilePaths.forEach(cssPath => {
         ...
         if (baseUrl) {
          ...
          if (dontAppendStylesToHead) {
            const key = 'css__mfe_auth__' + exposeItemName;
